def prettyjson(obj, indent=4, maxlinelength=80):
    ...
    return indent_items(items, indent, level=0)
...
def getsubitems(obj, itemkey, islast, maxlinelength, indent):
    ...
    if isbasictype:
        ...
        items.append(itemkey + keyseparator + basic_type_to_str(obj) + itemseparator)
        ...
        for (i, k) in enumerate(keys):
            islast_ = i == len(obj) - 1
            itemkey_ = ""
            if isdict: itemkey_ = basic_type_to_str(k)
